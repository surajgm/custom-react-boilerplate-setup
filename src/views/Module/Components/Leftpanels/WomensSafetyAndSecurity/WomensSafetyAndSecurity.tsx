...
import {
  WomensSafetyAndSecurityChartKeys,
  chartComponents,
  charts,
  dropDownKeys,
...
export const WomensSafetyAndSecurity = () => {
  const [chart, setChart] = useState<WomensSafetyAndSecurityChartKeys | 'All'>(
    'All'
  );
  const containerRef = useRef<HTMLDivElement>(null);
  const { slice } = useContext(DataContext);
  console.log('Context-Women');
  return (
    <div className="flex flex-col gap-3">
      ...
      <div className="flex items-center gap-3">
        <Dropdown<WomensSafetyAndSecurityChartKeys>
          chart={chart}
          setChart={setChart}
          data={dropDownKeys}
        />
